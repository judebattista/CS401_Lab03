...
HD_PWD='Z:/jbattista20/CS-401-1-CompArch/Lab03/mips_fpga_nexsys4_ddr/mips.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log computer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source computer_top.tcl
